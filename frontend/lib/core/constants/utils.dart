...
Color strengthenColor(Color color, double factor) {
  int r = ((color.r * 255.0).round() * factor).clamp(0, 255).toInt();
  int g = ((color.g * 255.0).round() * factor).clamp(0, 255).toInt();
  int b = ((color.b * 255.0).round() * factor).clamp(0, 255).toInt();
